package com.inlym.lifehelper.system.controller;
...
public class DebugController {
  ...
  public Map<String, Object> getProfile() {
    ...
    map.put(
        "logging.level.com.inlym.lifehelper",
        environment.getProperty("logging.level.com.inlym.lifehelper"));
  ...
  public CustomRequestContext getCustomRequestContext(HttpServletRequest request) {
    CustomRequestContext context =
        (CustomRequestContext) request.getAttribute(CustomRequestContext.NAME);
