...
import com.inlym.lifehelper.user.account.service.UserAccountWeChatService;
...
public class WeChatLoginService {
    ...
    public IdentityCertificate loginByWeChatCode(String appId, String code, String ip) {
        ...
        WeChatAccountInfo weChatAccountInfo = WeChatAccountInfo
                .builder()
                .appId(appId)
        ...
        IdentityCertificate identityCertificate =
                simpleTokenService.generateIdentityCertificate(weChatUserAccount.getUserId());
