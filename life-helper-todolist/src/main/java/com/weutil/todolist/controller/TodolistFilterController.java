...
public class TodolistFilterController {
     ...
     * @since 3.0.0
     */
    @GetMapping("/todolist/filters/{filter_name}/count-uncompleted")
    @UserPermission
    public SingleNumberResponse countUncompletedTasks(@UserId long userId, @PathVariable("filter_name") String filterName) {
        ...
        long num = todolistFilterService.countUncompletedTasks(userId, filter);
