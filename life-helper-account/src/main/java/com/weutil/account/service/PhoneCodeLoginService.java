...
import com.weutil.account.mapper.LoginHistoryMapper;
...
public class PhoneCodeLoginService {
    ...
    public IdentityCertificate loginBySmsCode(String checkTicket, String code, String ip) {
        ...
        LoginHistory history = LoginHistory.builder()
                .loginMethod(LoginMethod.PHONE_SMS)
        ...
        // 发布手机号使用短信验证码登录事件
        applicationEventPublisher.publishEvent(new LoginByPhoneCodeEvent(history));
