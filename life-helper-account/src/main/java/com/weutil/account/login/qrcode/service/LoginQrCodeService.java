...
import com.weutil.account.login.qrcode.event.LoginQrCodeLackEvent;
import com.weutil.account.login.qrcode.model.LoginQrCode;
import com.weutil.common.base.aliyun.oss.constant.OssDir;
import com.weutil.common.base.aliyun.oss.service.OssService;
...
public class LoginQrCodeService {
    ...
    private LoginQrCode generate() {
        ...
        UnlimitedQrCodeOptions options = UnlimitedQrCodeOptions.builder().scene(id).page(WECHAT_SCAN_LOGIN_PAGE).width(300).envVersion("release").build();
