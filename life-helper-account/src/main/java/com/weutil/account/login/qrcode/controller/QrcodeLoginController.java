package com.weutil.account.login.qrcode.controller;

import com.weutil.account.login.qrcode.entity.LoginTicket;
import com.weutil.account.login.qrcode.model.LoginByQrCodeDTO;
import com.weutil.account.login.qrcode.model.LoginByQrCodeResultVO;
import com.weutil.account.login.qrcode.model.LoginQrCode;
import com.weutil.account.login.qrcode.model.ScanLoginQrCodeResultVO;
import com.weutil.account.login.qrcode.service.QrcodeLoginService;
