...
import com.weutil.external.heweather.HeDataService;
...
public class WeatherDataService {
     ...
     */
    @SneakyThrows
    private static List<WeatherDaily> mergeCompletableWeatherDailyAndAir(CompletableFuture<List<WeatherDaily>> weatherDaily,
                                                                         CompletableFuture<List<AirDaily>> airDaily) {
        CompletableFuture
